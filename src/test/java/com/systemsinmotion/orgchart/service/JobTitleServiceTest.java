...
public class JobTitleServiceTest {
	...
	private ArrayList<JobTitle> listOfFoundEmpls = new ArrayList<JobTitle>();

	@Before
	public void before() throws Exception {
		when(this.mockJobTitle.getId()).thenReturn(Entities.JOB_TITLE_ID);
		this.listOfFoundEmpls.add(this.mockJobTitle);
		when(this.mockJobTitleDAO.findAll()).thenReturn(this.listOfFoundEmpls);
	...
	@Test
	public void findByJobTitleByID() {
