...
public class EmployeeRepositoryTest {
	...
	public void before() throws Exception {
		...
		this.deptRepo.save(this.department);

		this.employee = Entities.employee(this.department);
		this.employee.setDepartment(this.department);
		
		this.employee.setId(this.empRepo.saveAndFlush(this.employee).getId());
	}
...
//		List<Employee> emps = this.empRepo.findByManager(Entities.manager());
//		assertNull(emps);
//	}
