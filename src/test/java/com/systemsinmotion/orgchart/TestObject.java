...
public class TestObject {
	...
	public static Department department() {
		Department department = new Department(null, manager(), departmentName(), null, null);
	...
	public static Employee employee() {
		Employee emp = new Employee(r.nextInt(), null, department(), null, FIRST_NAME, LAST_NAME, EMAIL, SKYPE_NAME, false,
				null, null);
		emp.setEmployeeId(r.nextInt());
		return emp;

	}

	public static Employee manager() {
		Employee mgr = new Employee(r.nextInt(), null, null, null, FIRST_NAME, LAST_NAME, EMAIL + r.nextInt(), SKYPE_NAME + r.nextInt(), true,
				null, null);
		mgr.setEmployeeId(MANAGER_ID);
		return mgr;
	}
