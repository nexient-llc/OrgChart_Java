...
//	}
	...
	public void testModelShouldContainNewDepartmentList() {
	 ...
	 public void testModelShouldUpdateOnDepartmentPagePost() {
		 findAllDepartmentsList = (List<Department>) mockDepartmentService.findAllDepartments();
		 //System.out.println("size is: " + findAllDepartmentsList.size());
		 ...
		 System.out.println("id is: " + findAllDepartmentsList.get(0).getId());
