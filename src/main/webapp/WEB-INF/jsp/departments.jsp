...
<table id="t1">
	...
	<c:forEach items="${depts}" var="dept">
		<tr>
			...
			<td><input type="submit" value="Edit" class="depEditBtn"
				data-id="${dept.id}" /></td>
		</tr>
	</c:forEach>
</table>
	...
	<div id="dangerZone">
		...
		<form action="departments/delete" method="post">
			<fieldset>
				...
				department's <b>name</b> (case sensitive) and press remove to erase
				them permanently: <input type="text" name="confirmString"
