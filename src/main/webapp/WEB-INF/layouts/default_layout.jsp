...
<body>
	...
	<table>
		<tr>
			<th><label id="navBarHome" >Home</label></th>
			<th><label id="navBarDepts" >Departments</label></th>
			<th><label id="navBarEmps">Employees</label></th>
			<th><label id="navBarJobs" >Job Titles</label></th>
		</tr>
	</table>
