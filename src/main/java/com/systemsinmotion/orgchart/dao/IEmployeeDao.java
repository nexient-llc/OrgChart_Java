...
public interface IEmployeeDao {
	...
	/**
	 * Returns all <code>Employee</code> instances belonging to a given <code>Department</code> as a <code>List</code>
	 * 
	 * @return List of Employees
	 */
	...
	/**
	 * Returns an <code>Employee</code> instance having a given <code>email</code> value.
	 * 
	 * @param email
	...
	/**
	 * Returns an <code>Employee</code> instance having a given <code>id</code> value.
	 * 
	 * @param id
	 *            Identifier of <code>Employee</code> instance to find
	 * @return Single <code>Employee</code> instance. Null if not found.
	...
	/**
	 * Saves a given <code>Employee</code> instance and returns its generated id.
	 * 
	 * @param employee
	...
	/**
	 * Updates data for a given <code>Employee</code> instance.
	 * 
	 * @param employee
